...
import { EDVisitStatus, TriageScale, ArrivalMode, AcuityLevel, TraumaType, BayAssignmentStatus, EDBayStatus, EDOrderType, EDOrderStatus, DispositionType, WorkflowStatus, } from './emergency.types.js';
...
const EDVisitSchema = new Schema({
...
const EDBaySchema = new Schema({
    ...
    occupiedCount: { type: Number, min: 0, default: 0 },
...
const BayAssignmentSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    visitId: { type: Schema.Types.ObjectId, ref: 'EDVisit', required: true, index: true },
    patientId: { type: Schema.Types.ObjectId, ref: 'Patient', index: true },
...
const EDOrderSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    visitId: { type: Schema.Types.ObjectId, ref: 'EDVisit', required: true, index: true },
    patientId: { type: Schema.Types.ObjectId, ref: 'Patient', index: true },
...
const DispositionRecordSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    visitId: { type: Schema.Types.ObjectId, ref: 'EDVisit', required: true, index: true },
    patientId: { type: Schema.Types.ObjectId, ref: 'Patient', index: true },
...
export const EDVisitModel = mongoose.models.EDVisit || model('EDVisit', EDVisitSchema);
export const TriageAssessmentModel = mongoose.models.TriageAssessment || model('TriageAssessment', TriageAssessmentSchema);
export const EDBayModel = mongoose.models.EDBay || model('EDBay', EDBaySchema);
export const BayAssignmentModel = mongoose.models.BayAssignment || model('BayAssignment', BayAssignmentSchema);
export const EDOrderModel = mongoose.models.EDOrder || model('EDOrder', EDOrderSchema);
export const DispositionRecordModel = mongoose.models.DispositionRecord || model('DispositionRecord', DispositionRecordSchema);
