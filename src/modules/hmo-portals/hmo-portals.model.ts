...
import type { PortalNotificationType } from './hmo-portals.types.js';
...
memberPortalProfileSchema.index(
  { hmoId: 1, memberId: 1 },
  { unique: true },
);
...
providerPortalProfileSchema.index(
  { hmoId: 1, providerId: 1 },
  { unique: true },
);
 ...
 */
export const MemberPortalProfileModel =
  mongoose.models.MemberPortalProfile ??
  model('MemberPortalProfile', memberPortalProfileSchema);

export const ProviderPortalProfileModel =
  mongoose.models.ProviderPortalProfile ??
  model('ProviderPortalProfile', providerPortalProfileSchema);

export const PortalNotificationModel =
