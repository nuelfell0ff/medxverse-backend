...
import { InvoiceType, InvoiceStatus, PaymentType, PaymentMethod, PaymentStatus, SettlementType, SettlementStatus, ReconciliationStatus, } from './hmo-billing.types.js';
...
export const ProviderSettlementModel = mongoose.models.ProviderSettlement ??
    mongoose.model('ProviderSettlement', settlementSchema);
export const HmoPaymentModel = mongoose.models.HmoPayment ??
    mongoose.model('HmoPayment', paymentSchema);
export const BillingReconciliationModel = mongoose.models.BillingReconciliation ??
    mongoose.model('BillingReconciliation', reconciliationSchema);
