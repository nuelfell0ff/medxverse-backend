...
const FamilyCommunicationLogSchema =
  new Schema<IFamilyCommunicationLogDocument>(
    {
      hospitalId: {
        type: Schema.Types.ObjectId,
        ref: 'Account',
...
export const ICUAdmissionModel =
  mongoose.models.ICUAdmission ||
  model<IICUAdmissionDocument>(
    'ICUAdmission',
    ICUAdmissionSchema,
  );

export const DeviceReadingModel =
  mongoose.models.DeviceReading ||
  model<IDeviceReadingDocument>(
    'DeviceReading',
    DeviceReadingSchema,
  );

export const FlowsheetEntryModel =
  mongoose.models.FlowsheetEntry ||
  model<IFlowsheetEntryDocument>(
    'FlowsheetEntry',
    FlowsheetEntrySchema,
  );

export const ICUScoreModel =
  mongoose.models.ICUScore ||
  model<IICUScoreDocument>(
    'ICUScore',
    ICUScoreSchema,
  );
...
export const FamilyCommunicationLogModel =
  ...
  model<IFamilyCommunicationLogDocument>(
    'FamilyCommunicationLog',
    FamilyCommunicationLogSchema,
  );