...
import { BloodGroup, BloodComponentType, BloodUnitStatus, TransfusionRequestStatus, TransfusionUrgency, CrossmatchResult, } from './blood-bank.types.js';
...
export const BloodUnitModel = model('BloodUnit', BloodUnitSchema);
const TransfusionRequestSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
...
export const TransfusionRequestModel = model('TransfusionRequest', TransfusionRequestSchema);
