...
import { AssessmentType, SeverityLevel, SuicideRiskLevel, SessionType, SessionStatus, } from './mental-health.types.js';
...
export const MentalHealthAssessmentModel = model('MentalHealthAssessment', MentalHealthAssessmentSchema);
const PsychotherapySessionSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    patientId: { type: Schema.Types.ObjectId, ref: 'Patient', required: true, index: true },
...
export const PsychotherapySessionModel = model('PsychotherapySession', PsychotherapySessionSchema);
