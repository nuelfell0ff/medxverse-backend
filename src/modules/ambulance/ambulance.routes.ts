...
router.patch('/:id/status', (req, res, next) =>
  ambulanceController.updateAmbulanceStatus(req, res, next)
);
...
router.patch('/trips/:id/assign', (req, res, next) =>
  ambulanceController.assignTrip(req, res, next)
);
router.patch('/trips/:id/status', (req, res, next) =>
  ambulanceController.updateTripStatus(req, res, next)
);
