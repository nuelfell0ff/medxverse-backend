...
router.post('/:id/renew', (req, res, next) => enrolleesController.renewEnrollee(req, res, next));
router.get('/:id/card', (req, res, next) => enrolleesController.getCard(req, res, next));
router.get('/:id/history', (req, res, next) => enrolleesController.getLifecycle(req, res, next));
