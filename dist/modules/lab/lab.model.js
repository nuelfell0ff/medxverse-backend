...
export const LabOrderModel = mongoose.models.LabOrder ||
    model('LabOrder', LabOrderSchema);
export const TestCatalogModel = mongoose.models.TestCatalog ||
    model('TestCatalog', TestCatalogSchema);
