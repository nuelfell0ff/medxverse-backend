...
const DentalChartSchema = new Schema<IDentalChartDocument>(
  {
...
export const DentalChartModel = model<IDentalChartDocument>('DentalChart', DentalChartSchema);

const DentalProcedureSchema = new Schema<IDentalProcedureDocument>(
  {
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    patientId: { type: Schema.Types.ObjectId, ref: 'Patient', required: true, index: true },
...
export const DentalProcedureModel = model<IDentalProcedureDocument>(
  'DentalProcedure',
