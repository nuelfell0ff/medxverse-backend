...
const ControlledSubstanceLogSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
...
export const DispenseRecordModel = mongoose.models.DispenseRecord || mongoose.model('DispenseRecord', DispenseRecordSchema);
export const FormularyEntryModel = mongoose.models.FormularyEntry || mongoose.model('FormularyEntry', FormularyEntrySchema);
export const InventoryTransactionModel = mongoose.models.InventoryTransaction || mongoose.model('InventoryTransaction', InventoryTransactionSchema);
export const ControlledSubstanceLogModel = mongoose.models.ControlledSubstanceLog || mongoose.model('ControlledSubstanceLog', ControlledSubstanceLogSchema);
