...
import { AccreditationStatus, ProviderContractStatus, ProviderPaymentModel, ProviderStatus, ProviderType, } from './provider.types.js';
...
const existing = mongoose.models.HMOProvider;
export const HMOProviderModel = existing ?? mongoose.model('HMOProvider', providerSchema);
