...
export const InventoryItemModel = model<IInventoryItemDocument>('InventoryItem', InventoryItemSchema);
export const DispenseRecordModel = model<IDispenseRecordDocument>('DispenseRecord', DispenseRecordSchema);