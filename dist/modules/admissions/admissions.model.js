...
import { BedType, AdmissionStatus, } from './admissions.types.js';
...
const InpatientAdmissionSchema = new Schema({
...
export const InpatientAdmissionModel = model('InpatientAdmission', InpatientAdmissionSchema);
