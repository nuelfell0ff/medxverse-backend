...
router.post('/prescriptions', (req, res, next) => eyeClinicController.createOpticalPrescription(req, res, next));
router.get('/prescriptions', (req, res, next) => eyeClinicController.getOpticalPrescriptions(req, res, next));
router.get('/prescriptions/:id', (req, res, next) => eyeClinicController.getOpticalPrescriptionById(req, res, next));
