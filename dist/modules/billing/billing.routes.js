...
router.get('/catalogue/available', controller.getAvailablePricingCatalogues);
router.post('/catalogue/resolve-price', controller.resolvePrice);
router.get('/catalogue/:id/history', controller.getPricingCatalogueHistory);
