...
router.patch('/:id/consent', (req, res, next) => surgeryController.updateConsent(req, res, next));
router.patch('/:id/team', (req, res, next) => surgeryController.updateTeam(req, res, next));
router.patch('/:id/reschedule', (req, res, next) => surgeryController.rescheduleCase(req, res, next));
router.post('/:id/medications', (req, res, next) => surgeryController.addMedication(req, res, next));
router.patch('/:id/medications/administer', (req, res, next) => surgeryController.administerMedication(req, res, next));
router.patch('/:id/who-checklist', (req, res, next) => surgeryController.updateWHOChecklist(req, res, next));
