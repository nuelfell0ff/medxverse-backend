...
import { IChainOfCustody, ISpecimenDocument, ITestResultDocument, IReferenceRangeDocument, ICriticalAlertDocument, IAnalyzerInterfaceDocument, SpecimenStatus, CriticalAlertStatus, AnalyzerProtocol, ResultFlag, EntryMethod } from './lab.types.js';
...
const SpecimenSchema = new Schema<ISpecimenDocument>({
...
const ReferenceRangeSchema = new Schema<IReferenceRangeDocument>({
  hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
...
const CriticalAlertSchema = new Schema<ICriticalAlertDocument>({
  hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
  orderId: { type: Schema.Types.ObjectId, ref: 'LabOrder', required: true, index: true },
...
const AnalyzerInterfaceSchema = new Schema<IAnalyzerInterfaceDocument>({
  hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
...
export const SpecimenModel = mongoose.models.Specimen || model<ISpecimenDocument>('Specimen', SpecimenSchema);
export const TestResultModel = mongoose.models.TestResult || model<ITestResultDocument>('TestResult', TestResultSchema);
export const ReferenceRangeModel = mongoose.models.ReferenceRange || model<IReferenceRangeDocument>('ReferenceRange', ReferenceRangeSchema);
export const CriticalAlertModel = mongoose.models.CriticalAlert || model<ICriticalAlertDocument>('CriticalAlert', CriticalAlertSchema);
export const AnalyzerInterfaceModel = mongoose.models.AnalyzerInterface || model<IAnalyzerInterfaceDocument>('AnalyzerInterface', AnalyzerInterfaceSchema);
