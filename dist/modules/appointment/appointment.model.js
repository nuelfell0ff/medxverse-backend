...
import { AppointmentStatus, AppointmentType, QueuePriority, ReminderChannel, ReminderStatus, QueueTicketStatus, } from './appointment.types.js';
...
export const ProviderScheduleModel = mongoose.models.ProviderSchedule || mongoose.model('ProviderSchedule', ScheduleSchema);
export const QueueTicketModel = mongoose.models.QueueTicket || mongoose.model('QueueTicket', QueueSchema);
export const ReminderLogModel = mongoose.models.ReminderLog || mongoose.model('ReminderLog', ReminderSchema);
export const NoShowRiskScoreModel = mongoose.models.NoShowRiskScore || mongoose.model('NoShowRiskScore', RiskSchema);
