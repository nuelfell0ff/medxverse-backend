...
import { EligibilityServiceCategory, IEligibilityCheck } from './eligibility.types.js';
...
export const EligibilityCheckModel =
  mongoose.models.HMOEligibilityCheck ||
  mongoose.model<IEligibilityCheck>('HMOEligibilityCheck', EligibilityCheckSchema);
