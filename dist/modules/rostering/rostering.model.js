...
import { AssignmentStatus, RosterAreaType, RosterStatus, ShiftStatus, ShiftType, } from './rostering.types.js';
/* =========================================================
   ASSIGNMENT SCHEMA
========================================================= */
...
/* =========================================================
   ROSTER MODEL
========================================================= */
export const RosterModel = mongoose.models.Roster ||
...
========================================================= */
export const StaffAvailabilityModel = mongoose.models.StaffAvailability ||
    mongoose.model('StaffAvailability', StaffAvailabilitySchema);
/* =========================================================
   SHIFT SWAPS
========================================================= */
...
/* =========================================================
   SHIFT SWAP MODEL
========================================================= */
export const ShiftSwapModel = mongoose.models.ShiftSwap ||
    mongoose.model('ShiftSwap', ShiftSwapSchema);
/* =========================================================
   SHIFT HANDOVERS
========================================================= */
...
========================================================= */
export const ShiftHandoverModel = mongoose.models.ShiftHandover ||
