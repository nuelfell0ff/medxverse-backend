...
const UtilizationEventSchema = new Schema({
...
export const UtilizationEventModel = mongoose.models.HMOUtilizationEvent ||
    mongoose.model('HMOUtilizationEvent', UtilizationEventSchema);
export const FraudRuleModel = mongoose.models.HMOFraudRule ||
    mongoose.model('HMOFraudRule', FraudRuleSchema);
export const FraudAlertModel = mongoose.models.HMOFraudAlert ||
    mongoose.model('HMOFraudAlert', FraudAlertSchema);
export const FraudCaseModel = mongoose.models.HMOFraudCase ||
    mongoose.model('HMOFraudCase', FraudCaseSchema);
