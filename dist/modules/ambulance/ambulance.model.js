...
import { VehicleType, VehicleStatus, TripPriority, TripStatus, } from './ambulance.types.js';
...
export const AmbulanceModel = model('Ambulance', AmbulanceSchema);
...
export const TripRequestModel = model('TripRequest', TripRequestSchema);
