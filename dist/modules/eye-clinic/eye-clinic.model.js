...
import { ExamType, PrescriptionType, LensType, } from './eye-clinic.types.js';
...
const EyeExamSchema = new Schema({
...
export const EyeExamModel = model('EyeExam', EyeExamSchema);
const OpticalPrescriptionSchema = new Schema({
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    patientId: { type: Schema.Types.ObjectId, ref: 'Patient', required: true, index: true },
...
export const OpticalPrescriptionModel = model('OpticalPrescription', OpticalPrescriptionSchema);
