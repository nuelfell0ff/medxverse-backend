...
import { BenefitCategory, PackageStatus, } from './benefits.types.js';
...
const BenefitPackageSchema = new Schema({
    hmoId: {
    ...
    rules: {
        ...
        default: [],
        validate: {
            validator: (rules) => Array.isArray(rules),
...
export const BenefitPackageModel = model('BenefitPackage', BenefitPackageSchema);
