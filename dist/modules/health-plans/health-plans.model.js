...
import { BenefitCategory, BenefitStatus, HealthPlanStatus, HealthPlanType, PremiumFrequency, } from './health-plans.types.js';
...
const benefitDefinitionSchema = new Schema({
...
export const BenefitDefinitionModel = mongoose.models.BenefitDefinition || model('BenefitDefinition', benefitDefinitionSchema);
export const HealthPlanModel = mongoose.models.HealthPlan || model('HealthPlan', healthPlanSchema);
export const PlanBenefitModel = mongoose.models.PlanBenefit || model('PlanBenefit', planBenefitSchema);
