...
const DietaryOrderSchema = new Schema<IDietaryOrderDocument>(
  {
...
export const DietaryOrderModel = model<IDietaryOrderDocument>(
  'DietaryOrder',
  DietaryOrderSchema
);

const MealDeliverySchema = new Schema<IMealDeliveryDocument>(
  {
    hospitalId: { type: Schema.Types.ObjectId, ref: 'Account', required: true, index: true },
    dietaryOrderId: {
...
export const MealDeliveryModel = model<IMealDeliveryDocument>(
  'MealDelivery',
  MealDeliverySchema
);